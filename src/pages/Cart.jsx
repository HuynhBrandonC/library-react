                    ...
                    <div className="row">
                                        ...
                                        <div className="cart__item">
                                            ...
                                            <div className="cart__quantity">
                                                <input type="number" min="0" max="99"
                                                    value={book.quantity} className="cart__input"
                       ...
                       {cart.length <=0 && <div className="cart__empty">
                        ...
                        {cart.length > 0 && <div className="total">
                            ...
                            <button className="btn btn__checkout no-cursor" onClick={() => alert("Haven't Implemented this feature")}>Proceed to checkout</button>
                        </div>}
                    </div>
                </div>
            </main>
